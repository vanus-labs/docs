...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.3/linux-amd64/vsctl
chmod ug+x vsctl
...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.3/macos-arm64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.3/macos-amd64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
| GitCommit | a74cef0                         |
| BuildDate | 2022-12-15_16:29:27+0000        |
...
```shell
...                                                                                                                                                   │
time="2022-12-15T16:39:15.368524581Z" level=info msg="receive a new event" in_total=3
{
  "specversion": "1.0",
  "id": "1st",
  "source": "quick-start-filter-section",
  "type": "cmd",
  "datacontenttype": "application/json",
  "time": "2022-12-15T16:39:12.361856014Z",
  "data": {
    "msg": "1st event, DISPLAY: YES"
  },
  "xvanusstime": "2022-12-15T16:39:12.362Z",
  "xvanuseventbus": "quick-start"
}
```
