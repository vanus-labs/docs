...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.1/linux-amd64/vsctl
chmod ug+x vsctl
...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.1/macos-arm64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.1/macos-amd64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
| GitCommit | 08b24fc                         |
| BuildDate | 2022-12-09_15:44:09+0000        |
