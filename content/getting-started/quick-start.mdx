...
```bash
kubectl apply -f https://download.linkall.com/all-in-one/v0.5.0.yml
```
...
```bash
kubectl apply -f https://download.linkall.com/all-in-one/v0.5.0.cn.yml
```
...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.0/linux-amd64/vsctl
chmod ug+x vsctl
...
```bash
curl -O https://download.linkall.com/vsctl/v0.5.0/macos-arm64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
| GitCommit | 4b3b4d0                         |
| BuildDate | 2022-11-29_15:10:22+0000        |
