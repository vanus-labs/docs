# GitHub issue comment event triggers a Slack message
...
This guide will help you get a Slack notification whenever someone leaves a comment in your repository.
...
- Log in to [Vanus Cloud](https://cloud.vanus.ai/) and choose the **GitHub Issue Comment event triggers a Slack message** template.
...
- After submission, the status will show as **running**. Now everytime a new comment is added on a issue on your GitHub repository, you will instantly recieve a customized notification message
