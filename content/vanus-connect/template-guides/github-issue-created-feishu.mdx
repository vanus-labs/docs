...
- Log in to  [Vanus Connect](https://cloud.vanus.ai/)  and choose the **GitHub issue event triggers a Feishu message** template.
...
![2.png](./imgs/github-issue-created-feishu-2.png)

![3.png](./imgs/github-issue-created-feishu-3.png)
...
![4.png](./imgs/github-issue-created-feishu-4.png)
...
![5.png](./imgs/github-issue-created-feishu-5.png)

### Result Display

- When a new issue is created, you will receive a real-time GitHub Issue Notification in Feishu.

![6.png](./imgs/github-issue-created-feishu-6.png)
