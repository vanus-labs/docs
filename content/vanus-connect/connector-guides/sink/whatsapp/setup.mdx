...
If you enabled Chat AI on the WhatsApp Source Connector, you have set up ChatGPT on WhatsApp Connection. The following steps will guide you on how to complete the ChatGPT on WhatsApp Connection.

## Using *ChatGPT Personal Assistant for WhatsApp* Template
