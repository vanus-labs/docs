...
3. If you opt for an **Hourly** schedule, you can choose the specific minute and second within every hour when the event will be sent. This means that the event will be dispatched at the same minute and second within every subsequent hour that it is scheduled to run.
