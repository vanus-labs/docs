...
It should be noted that v_host refers to the host address and port where your connector run and it must be accessible 
...
You can verify if the Amazon SNS Source works properly by publishing a message to the SNS topic.
