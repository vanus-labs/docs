...
```bash
kubectl apply -f https://dl.vanus.ai/all-in-one/v0.5.7.yml
```
...
```bash
kubectl apply -f https://dl.vanus.ai/all-in-one/v0.5.7.cn.yml
```
...
```bash
curl -O https://dl.vanus.ai/vsctl/v0.5.7/linux-amd64/vsctl
chmod ug+x vsctl
...
```bash
curl -O https://dl.vanus.ai/vsctl/v0.5.7/macos-arm64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
```bash
curl -O https://dl.vanus.ai/vsctl/v0.5.7/macos-amd64/vsctl
chmod ug+x vsctl
mv vsctl /usr/local/bin
```
...
```shell
kubectl apply -f https://dl.vanus.ai/utils/display.yml
```
