...
const sidebars = {
  vanusDoc: [
    ...
    },
    {
      ...
      items: [
          "vanus-connect/template-guides/github/issue-comment/discord/index",
          "vanus-connect/template-guides/github/issue-open/discord/index",
          "vanus-connect/template-guides/github/pr-open/discord/index",
          "vanus-connect/template-guides/github/star/discord/index",
          "vanus-connect/template-guides/shopify/customers-create/mailchimp/index",
          "vanus-connect/template-guides/shopify/orders-paid/discord/index",
          "vanus-connect/template-guides/shopify/orders-paid/google-sheets/index",
          "vanus-connect/template-guides/shopify/product-create/google-sheets/index",
